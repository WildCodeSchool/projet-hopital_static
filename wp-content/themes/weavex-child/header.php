 ...
 *	>>>> DO NOT EDIT THIS FILE <<<<
 */
/*Ce site à été dévellopé par Mélanie Gourpil, Quentin Gallois, Manuel Martinez avec l'aide de Florian Grandjean de la WCS */
...
?>
	...
	<a href="http://80.67.190.170/projet-hopital_static/?page_id=399"><button class="header_button second_button" type="button" class="btn btn-primary btn-lg">
		Nous contacter
	</button></a>
	
	<form role="search" method="get" class="search-form" action="http://80.67.190.170/projet-hopital_static/">
		<label class="header_button third_button" >
			<input type="search" class="header_button" placeholder="Recherche…" value="" name="s" title="Rechercher&nbsp;:">
